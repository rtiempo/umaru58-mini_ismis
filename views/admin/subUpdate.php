                ...
                <fieldset>
                    <?php if($row = mysqli_fetch_assoc($result)) : ?>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="text" name="subName" class="form-control" placeholder="<?php echo $row["subName"]; ?>">
                        </div>
                        <div class="form-group">
                            <label for="maxstud">Max Students</label>
                            <input type="number" name="maxStud" class="form-control" placeholder="<?php echo $row["maxStud"]; ?>">
                        </div>                        
                        <!-- <div class="form-group">
                                ...
                                <option value="<?php // echo $row["facultyId"]; ?>">
                                    ...
                                    <?php // if(mysqli_num_rows($result) > 0) : ?>                
                                        <?php // ($row = mysqli_fetch_assoc($result)) : ?>
                                            <?php // echo $row['lName'].", ";echo $row['fName']; ?>
                                        <?php // endwhile; ?>
                                    <?php // endif; ?> 
                                </option>
                                <?php
                        ...
                        <button type="submit" name="subUpdate" class="btn btn-outline-primary mt-5">Update</button>
                    <?php endif; ?>
                </fieldset>
            </form>
        </div>
